...
import java.util.*;
// in this code we learn object class and constructor;
...
lhs(reference i.e. bus) is looked by compiler & rhs (object i.e. new Bus()) is looked by jvm
	 * 
	 * */
		 Student sonu=new Student(0, null, 0);
		//new operator dynamically allocate memory at the run time;
		...
		sonu.setData(roll, name, d);
		String data = sonu.getData();
		System.out.println(data);
		sc.close();
		
		System.out.println(sonu.getData());
...
class Student {
	...
	String name;
	double marks;
	public void setData(int rno,String name,double mark) {
		//we need a way to add the values of the above properties object by object;
		//using this keyword we do all the work
		/*The this Keyword:
...
parameterised super class constructor.*/
	...
	public String getData() {
		return "[ Roll number is: " + rno + ", Name is: " +name+ ", Marks: " + marks + " ]";
	...
	//when we declare a variable to final we can,t re assign it
	//garbase coolector-
	}
