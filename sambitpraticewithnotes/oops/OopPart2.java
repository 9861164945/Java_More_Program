...
public class OopPart2 {
    ...
    public static void main(String[] args) {
        /*
         * Principles of OOP:
         * There are 4 main properties of OOP, but class and object are also considered
         * properties, so there are 6 in total.
         * Main 4 are:
         * INHERITANE:
...
NOTE : Polymorphism does not apply to instance variables.
        ...
        System.out.println(box3.l + " " + box3.h + " " + box3.width);
    }
}
